...
<!-- main content - noi dung chinh trong chu -->
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header"><small>Sửa địa chỉ</small></h1>
			</div>
		</div><!--/.row-->
					...
					@if (count($errors) > 0)
						...
						<form action="" method="POST" role="form">
							...
							<div class="form-group">
								...
								<input type="text" name="address" class="form-control" value="{!! old('address', isset($data['address']) ? $data['address'] : null)!!}">
							</div>

							<div class="form-group">
								<label for="input-id">Số điện thoại</label>
								<input type="text" name="phone" class="form-control" value="{!! old('phone', isset($data['phone']) ? $data['phone'] : null)!!}">
							</div>
