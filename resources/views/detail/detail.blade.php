      ...
      <div class="img-slider">
        <ul id="owl-detailpro" class="owl-carousel owl-theme owl-listChoise">
            <?php $i=0; foreach($data->detail_img as $row) : $i++; ?>
             ...
             <li class="mediaSelected" data-toggle="modal" data-target="#detailImageModal" data-slide-to="<?php echo $i; ?>">
...
<?php $i=0; foreach($data->detail_img as $row) : $i++; ?>
<div id="mediaItem<?php echo $i;?>" class="item-media item <?php //if ($i == '1') {echo 'active';}?>"> 
  <img style="margin: 0 auto;" alt="item<?php echo $i-1;?>" src="{!!url('/uploads/products/details/'.$row->images_url)!!}">
</div>
<?php endforeach; ?>
<!--end carousel-inner--></div>
<!--Begin Previous and Next buttons-->
<a class="left carousel-control" href="#proDetailGallery" role="button" data-slide="prev"> <span class="glyphicon glyphicon-chevron-left"></span></a> <a class="right carousel-control" href="#proDetailGallery" role="button" data-slide="next"> <span class="glyphicon glyphicon-chevron-right"></span></a>
<!--end carousel--></div>
    ...
    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
      ...
      <div class="box-button">
        <div class="box-2-items">
          @if($data->status ==1)
          <a href="{!!url('gio-hang/addcart/'.$data->id)!!}" title="" class="btn btn-large btn-block btn-danger" style="font-size: 20px;"><i class="fa fa-cart-plus" aria-hidden="true"></i>Đặt mua ngay</a>
          @else
          <button rel="nofollow" class="btn btn-default no-product" disabled><i class="fa fa-cart-plus"></i> Tạm hết hàng</button>
          @endif
        </div>
        <div class="box-2-items end">
          <a href="tel:19000325" rel="nofollow" class="btn btn-large btn-block btn-success"><i class="fa fa-phone"></i> Hotline: 19000325</a>
        </div>
      </div>
