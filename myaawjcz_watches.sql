...
-- Généré le: Jeu 10 Août 2017 à 22:50
-- Version du serveur: 5.5.44-37.3-log
...
--
-- Base de données: `myaawjcz_watches`
--
...
--
-- Structure de la table `detail_img`
--
...
--
-- Contenu de la table `detail_img`
--
...
--
-- Structure de la table `groupnews`
--
...
--
-- Structure de la table `group_watch`
--
...
--
-- Contenu de la table `group_watch`
--
...
(2, 'Đồng hồ nữ', '#', '1496814694_banner-dong-ho-nu.jpg', 0, '2017-06-06 22:51:34', '2017-07-13 14:02:31'),
...
--
-- Structure de la table `kieuday`
--

CREATE TABLE IF NOT EXISTS `kieuday` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `name` text COLLATE utf8_unicode_ci NOT NULL,
  `status` int(11) NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
...
--
-- Structure de la table `kieumay`
--

CREATE TABLE IF NOT EXISTS `kieumay` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `name` text COLLATE utf8_unicode_ci NOT NULL,
  `status` int(11) NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
...
--
-- Structure de la table `oders_detail`
--
...
--
-- Contenu de la table `oders_detail`
--
...
--
-- Contenu de la table `pro_details`
--
...
--
-- Structure de la table `slidecate`
--

CREATE TABLE IF NOT EXISTS `slidecate` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
